---
id: frappe-deploy-safety
name: Frappe Deploy Safety
schema_version: 2.1
profile: foundation
level: recipe
maturity: candidate
...
Before Frappe bench/docker/deploy work, require migrate/build/smoke/rollback awareness and avoid force-recreate or production-like changes without gates.
...
- Source skill/material: `C:/Users/baenb/.claude/skills/frappe-deploy-safety/SKILL.md`.
