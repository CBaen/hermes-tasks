---
id: frappe-migration-fixture-discipline
name: Frappe Migration Fixture Discipline
schema_version: 2.1
profile: foundation
level: recipe
maturity: candidate
...
For DocType/schema/fixture/operator-state changes, separate model fields, Custom Fields, Property Setters, fixtures, migrations, and UI customizations with evidence.
...
3. Apply the workflow in the smallest useful form; do not create process theater.
4. Write durable notes/artifacts when the workflow produces decisions, research, reviews, or handoff state.
5. Report outcome with evidence and any blockers or unresolved risks.
...
- Source skill/material: `C:/Users/baenb/.claude/skills/frappe-migration-guard/SKILL.md and C:/Users/baenb/.claude/skills/frappe-fixture-discipline/SKILL.md`.
