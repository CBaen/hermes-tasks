---
id: divergent-option-contest
name: Divergent Option Contest
schema_version: 2.1
profile: foundation
level: recipe
maturity: candidate
...
Generate multiple viable options independently, critique/narrow them, and present a small recommended set instead of dumping choice overload on GL.
...
- Source skill/material: `C:/Users/baenb/.claude/skills/contest/SKILL.md`.
