---
id: triadic-construction-with-independent-review
name: Triadic Construction With Independent Review
schema_version: 2.1
profile: foundation
level: recipe
maturity: candidate
...
For multi-file implementation, separate builders by domain and run three independent reviewers before claiming done; referee disagreements and verify with tests.
...
- Source skill/material: `C:/Users/baenb/.claude/skills/triadic-construction-v2/SKILL.md`.
