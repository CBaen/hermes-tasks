---
id: frappe-payment-checkout-safety
name: Frappe Payment Checkout Safety
schema_version: 2.1
profile: foundation
level: recipe
maturity: candidate
...
For Stripe/payment/checkout/webhook/invoice/PDF/email paths, verify signatures, amount parity, secrets handling, receipt/invoice paths, and loud failure behavior.
...
- Source skill/material: `C:/Users/baenb/.claude/skills/frappe-payment-safety/SKILL.md`.
