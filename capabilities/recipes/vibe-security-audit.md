...
Audit AI-assisted web code for open CORS, redirect flaws, storage exposure, sensitive logs, unverified webhooks, frontend-only auth, dependency risk, rate limits, raw errors, and session weakness.
...
- Source skill/material: `C:/Users/baenb/.claude/skills/vibe-security-audit/SKILL.md`.
