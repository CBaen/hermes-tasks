---
id: frappe-form-integrity
name: Frappe Form Integrity
schema_version: 2.1
profile: foundation
level: recipe
maturity: candidate
...
Customer-facing Frappe forms must visibly succeed or visibly fail, create the intended backend record/path, and have smoke coverage.
...
- Source skill/material: `C:/Users/baenb/.claude/skills/frappe-form-integrity/SKILL.md`.
