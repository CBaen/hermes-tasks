---
id: stranger-ready-research-brief
name: Stranger Ready Research Brief
schema_version: 2.1
profile: foundation
level: recipe
maturity: candidate
...
Prepare a tight verified brief for fresh researchers: current truth, exact question, source boundaries, what not to assume, files/URLs to inspect first, and output contract.
...
- Source skill/material: `C:/Users/baenb/.claude/skills/research-brief/SKILL.md`.
