---
id: research-council-for-fundamental-decisions
name: Research Council For Fundamental Decisions
schema_version: 2.1
profile: foundation
level: recipe
maturity: candidate
...
For foundational decisions, separate codebase/internal analysis, external research, and devil's-advocate challenge, then synthesize tensions instead of forcing consensus.
...
- Source skill/material: `C:/Users/baenb/.claude/skills/research-council/SKILL.md`.
