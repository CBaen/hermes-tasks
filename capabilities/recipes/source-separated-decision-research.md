---
id: source-separated-decision-research
name: Source Separated Decision Research
schema_version: 2.1
profile: foundation
level: recipe
maturity: candidate
...
For decision-shaping research, keep web/docs/code or equivalent lanes separate before convergence, challenge, and GL-readable synthesis.
...
- Source skill/material: `C:/Users/baenb/.claude/skills/expedition/SKILL.md`.
