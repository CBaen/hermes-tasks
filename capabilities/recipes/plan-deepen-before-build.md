---
id: plan-deepen-before-build
name: Plan Deepen Before Build
schema_version: 2.1
profile: foundation
level: recipe
maturity: candidate
...
Stress-test an implementation plan before building: inspect assumptions, edge cases, project patterns, dependency/version risks, performance/security issues, then proceed/adjust/escalate with evidence.
...
- Source skill/material: `C:/Users/baenb/.claude/skills/plan-deepen/SKILL.md`.
